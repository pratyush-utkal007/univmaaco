                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-800 mb-3">
                        Discover Salesforce Sales Cloud
                      </h3>
                      <p className="text-gray-600 leading-relaxed">
                        Sales Cloud empowers your teams with AI-driven insights,
                        automation, and a streamlined pipeline to close deals
                        faster. Build stronger relationships, manage
                        opportunities, and drive revenue growth effectively.
                      </p>
                    </div>
